...
namespace RBAT.Core.Migrations.RBAT
{
    ...
    [Migration("20200421021658_AddedOptimalIdealPowerValue")]
    partial class AddedOptimalIdealPowerValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RBAT.Core.Models.ChannelOptimalSolutions", b =>
                {
                    ...
                    b.Property<DateTime?>("SimulationEndDate");

                    b.Property<DateTime?>("SimulationStartDate");

                    b.Property<bool>("UseUnitsOfVolume");
            ...
            modelBuilder.Entity("RBAT.Core.Models.ChannelOptimalSolutionsData", b =>
                {
                    ...
                    b.Property<double?>("IdealPowerValue");

                    b.Property<double?>("IdealValue");

                    b.Property<DateTime>("Modified");

                    b.Property<double?>("OptimalPowerValue");
            ...
            modelBuilder.Entity("RBAT.Core.Models.ChannelZoneLevelRecordedFlowStation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("RecordedFlowStation1Id");

                    b.Property<int?>("RecordedFlowStation2Id");

                    b.Property<int?>("RecordedFlowStation3Id");

                    b.Property<string>("UserName")
                        .HasMaxLength(256);

                    b.Property<int?>("Zone1Id");

                    b.Property<int?>("Zone2Id");

                    b.Property<int?>("Zone3Id");
                    ...
                    b.ToTable("ChannelZoneLevelRecordedFlowStation");
                });
            ...
            modelBuilder.Entity("RBAT.Core.Models.NodeZoneLevelHistoricReservoirLevel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("UseHistoricReservoirLevels");
                    ...
                    b.ToTable("NodeZoneLevelHistoricReservoirLevel");
                });
            ...
            modelBuilder.Entity("RBAT.Core.Models.Scenario", b =>
                {
                    ...
                    b.Property<int>("NumberOfLookaheadTimeSteps");
            ...
            modelBuilder.Entity("RBAT.Core.Models.ChannelZoneLevelRecordedFlowStation", b =>
                {
                    ...
                    b.HasOne("RBAT.Core.Models.ChannelPolicyGroup", "ChannelPolicyGroup")
                        .WithMany("ChannelZoneLevelRecordedFlowStations")
                        .HasForeignKey("ChannelPolicyGroupId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
