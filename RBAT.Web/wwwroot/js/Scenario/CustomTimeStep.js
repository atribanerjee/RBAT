...
var tscTable = $('#tscTable').DataTable({
    ...
    paging: false,
    ajax: {
        "url": "/CustomTimeStep/FillCustomTimeStep",
        "type": "POST",
        "datatype": "json",
        "data": function (d) {
            return $.extend({}, d, {
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    customTimeStepPasteFromClipboard();
                }
            },
            {
...
function tscSaveTable() {
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: "/CustomTimeStep/SaveCustomTimeSteps",
        data: {
...
async function customTimeStepPasteFromClipboard() {
    var pasteList = await tscConvertClipboardData();
    $.ajax({
        url: "/CustomTimeStep/GetDateFromClipboard",
        data: {
            elementID: document.getElementById("tscElementID").value,
        ...
        success: function (response) {
            if (!response.error) {
                reloadTableAfterClipboardPaste(response);
                tscSetButtons('paste');
            }
        }
    });
...
async function tscConvertClipboardData() {
...
function reloadTableAfterClipboardPaste(response) {
...
function tscSaveRow(e, dt, bt, config) {
    ...
    $.ajax({
        url: "/CustomTimeStep/UpdateCustomTimeStep",
        method: 'POST',
...
function tscRemoveRow(e, dt, bt, config) {
    ...
    $.ajax({
        url: "/CustomTimeStep/RemoveCustomTimeStep",
        method: 'POST',
